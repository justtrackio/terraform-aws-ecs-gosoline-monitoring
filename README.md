...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alarm_consumer"></a> [alarm\_consumer](#module\_alarm\_consumer) | justtrackio/ecs-alarm-consumer/aws | 1.2.1 |
| <a name="module_alarm_gateway"></a> [alarm\_gateway](#module\_alarm\_gateway) | justtrackio/ecs-alarm-gateway/aws | 1.4.1 |
| <a name="module_alarm_kinsumer"></a> [alarm\_kinsumer](#module\_alarm\_kinsumer) | justtrackio/ecs-alarm-kinsumer/aws | 1.1.2 |
...
| [grafana_folder.default](https://registry.terraform.io/providers/grafana/grafana/latest/docs/data-sources/folder) | data source |
...
| <a name="input_kibana_data_view_override"></a> [kibana\_data\_view\_override](#input\_kibana\_data\_view\_override) | Defines whether the data view should be overridden when one with the same name already exists | `bool` | `false` | no |
...
| <a name="input_label_orders"></a> [label\_orders](#input\_label\_orders) | Overrides the `labels_order` for the different labels to modify ID elements appear in the `id` | <pre>object({<br/>    cloudwatch    = optional(list(string), ["environment", "stage", "name"]),<br/>    ecs           = optional(list(string), ["stage", "name"]),<br/>    elasticsearch = optional(list(string), ["environment", "stage", "name"])<br/>    kibana        = optional(list(string), ["environment", "stage", "name"])<br/>  })</pre> | `{}` | no |
